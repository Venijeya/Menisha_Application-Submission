...
export default class Login extends Component {
    ...
    render() {
        return (
             < div className="login">
                <div className="quote">HoneyBee </div>  
                <div className="quote-1">Job Searching Website</div>  
                ...
                <div class="container my-5">
                    ...
                    <div className="form-group row">
                        <label className="col-sm-2 col-form-label text-left">Email: </label><br></br>
